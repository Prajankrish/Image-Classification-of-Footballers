...
def load_saved_artifacts():
    ...
    json_path = os.path.join(artifacts_path, "class_dictionary.json")
...
def get_cropped_image_if_2_eyes(image_path, image_base64_data):
    base_path = os.path.dirname(os.path.abspath(__file__))  # .../server
    face_cascade_path = os.path.join(base_path, "opencv", "haarcascades", "haarcascade_frontalface_default.xml")
    eye_cascade_path = os.path.join(base_path, "opencv", "haarcascades", "haarcascade_eye.xml")
